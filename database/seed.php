...
function seedDatabase()
{
    ...
    $lessonsMasterData = [
        ...
        [
            ...
            'content' => "<h2>Executive Masterclass: What is a Virtual Assistant?</h2><p>A Virtual Assistant (VA) is an independent remote professional who provides administrative, technical, creative, or strategic business support to founders, executives, and agencies. Rather than acting as a passive worker, top VAs operate as proactive operations partners.</p><h3>1. Primary Responsibilities & Core Value</h3><p>Virtual Assistants eliminate operational bottlenecks by handling inbox triage, calendar scheduling, web research, client onboarding, lead verification, and software maintenance. By taking over these recurring tasks, VAs save busy clients 10 to 20 hours every week.</p><h3>2. Real-World Example & Copy-Paste Script</h3><p><strong>Scenario:</strong> Client sends a vague request asking to organize their incoming emails.<br><strong>Proactive Script:</strong> 'Hi Client, I have set up 4 core folders (Urgent, Waiting on Client, Billing, Archive) and created 3 automated filters. Would you like me to draft responses for the Urgent folder daily at 9 AM?'</p><h3>3. Pro Tips & Tricks for VAs</h3><ul><li>Always request password manager access (LastPass or 1Password) rather than plain-text passwords.</li><li>Send structured End-of-Day (EOD) updates to show immediate value.</li></ul><h3>4. Common Pitfalls to Avoid</h3><p>Avoid waiting silently for step-by-step instructions. Proactive communication builds trust and long-term client retainers.</p>",
            'quiz' => [
                [
        ...
        [
            ...
            'content' => "<h2>Executive Masterclass: Freelancing vs Traditional Employment</h2><p>Transitioning from employee to freelancer requires shifting from trading presence for a paycheck to delivering measurable business value across client relationships.</p><h3>1. Income Structure & Diversification</h3><p>Traditional employees rely on a single employer for income and tax withholding. Freelancers contract with multiple clients, set their own rates, manage expenses, and protect their earnings through client diversification.</p><h3>2. Real-World Example & Copy-Paste Script</h3><p><strong>Scenario:</strong> Transitioning a trial client to a monthly retainer.<br><strong>Script:</strong> 'Hi Client, now that we have streamlined your calendar, I can manage your inbox and weekly lead research on a $1,000/month retainer. This guarantees 10 dedicated hours weekly for your account.'</p><h3>3. Pro Tips & Tricks for VAs</h3><ul><li>Set aside 20% to 30% of gross earnings for local taxes and business operational tools.</li><li>Never rely on a single client for 100% of your revenue.</li></ul><h3>4. Common Pitfalls to Avoid</h3><p>Avoid pricing your services too low out of fear; focus on communicating business outcomes rather than just hours worked.</p>",
            'quiz' => [
                [
