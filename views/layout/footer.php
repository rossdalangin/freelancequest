    ...
    <footer class="bg-slate-900 border-t border-slate-800 text-slate-400 text-xs py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div>
                <p>&copy; <?= date('Y') ?> <strong>FREELANCEQUEST</strong>. Play. Learn. Level Up. Get Clients. Get Paid.</p>
            </div>
            <div class="flex flex-wrap gap-4 text-xs font-semibold">
                ...
                <a href="/contact" class="hover:text-slate-200">Contact</a>
            </div>
        </div>
    </footer>
